...
namespace FluentScheduler.Tests.ScheduleTests
{
	...
	public class DelayFor_ToRunNow_Tests
	{
		...
		{
            TaskManager.AddTask(async () => { }, x => x.WithName("Should_Delay_ToRunNow_For_2_Seconds").ToRunNow().DelayFor(2).Seconds());
		...
		{
            TaskManager.AddTask(async () => { }, x => x.WithName("Should_Delay_ToRunNow_For_2_Minutes").ToRunNow().DelayFor(2).Minutes());
		...
		{
            TaskManager.AddTask(async () => { }, x => x.WithName("Should_Delay_ToRunNow_For_2_Hours").ToRunNow().DelayFor(2).Hours());
		...
		{
            TaskManager.AddTask(async () => { }, x => x.WithName("Should_Delay_ToRunNow_For_2_Days").ToRunNow().DelayFor(2).Days());
		...
		{
            TaskManager.AddTask(async () => { }, x => x.WithName("Should_Delay_ToRunNow_For_2_Weeks").ToRunNow().DelayFor(2).Weeks());
		...
		{
            TaskManager.AddTask(async () => { }, x => x.WithName("Should_Delay_ToRunNow_For_2_Months").ToRunNow().DelayFor(2).Months());
		...
		{
            TaskManager.AddTask(async () => { }, x => x.WithName("Should_Delay_ToRunNow_For_2_Years").ToRunNow().DelayFor(2).Years());
